...
from eval import compute_embedding, compute_knn
from models.utilsv2 import DataAugmentation, Head, Loss, MultiCropWrapper, clip_gradients
...
def main():
    ...
    print(vars(args))
    # Parameters
    vit_name, dim = "deit3_small_patch16_224.fb_in22k_ft_in1k", 384
